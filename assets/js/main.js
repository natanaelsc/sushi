...
const linkAction = () => {
    const navMenu = document.getElementById('nav-menu')
    // Quando clicado em qualquer nav__link a classe show-menu é removida.
    navMenu.classList.remove('show-menu')
}
...
const scrollUp = () => {
    ...
    // quando a rolagem for superior a 350 de altura da janela de visualização, adicione a classe show-scroll 
